...
class CreateEventsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('events', function (Blueprint $table) {
            ...
            $table->string('title');
            $table->text('first_patagraph', 10000)->nullable();
            $table->text('second_patagraph', 10000)->nullable();
            $table->string('date', 50)->nullable();
            $table->string('time', 50)->nullable();
            $table->string('video_link')->nullable();
            $table->string('highlight_text', 10000)->nullable();
            $table->boolean('publish', 0, 1)->default(0);
            $table->string('banner_image', 120)->nullable();	
            $table->text('descriptions', 15000)->nullable();
