            ...
            <div class="col-md-12">
                <div class="ibox">
                    ...
                    <div class="ibox-body" style="">
                        <form method="post" action="{{ route('branch.update', $detail->id) }}"
                            ...
                            <div class="row">
                                    ...
                                    <select name="district" class="form-control" id="select2">
                                        ...
                                        @foreach ($districts as $district)
                                            <option value="{{ $district }}"
                                                {{ $detail->district == $district ? 'selected' : '' }}>
                                                {{ ucfirst($district) }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    <label>Mobile</label>
                                    <input name="mobile" value="{{ $detail->mobile }}" type="text" class="form-control"
