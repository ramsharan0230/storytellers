...
@section('page_title', 'All interested country name')
...
<div class="page-heading">
    <h1 class="page-title">Interested countries</h1>
    @include('admin.layouts._partials.messages.info')
</div>
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All interested countries</div>
            <div>
                <a class="btn btn-info btn-md" href="{{route('country.create')}}">Add country</a>
            </div>
        </div>
            ...
            <table id="example-table" class="table table-striped table-bordered table-hover" cellspacing="0"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('country.edit', $data->id)}}" class="btn btn-success btn-sm"><i
                                    class="fa fa-edit"></i>
                            </a>
