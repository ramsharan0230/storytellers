    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                ...
                <div>
                    <a class="btn btn-info btn-md" href="{{ route('admin.datetime.create', $detail->id) }}">Add date and
                        time</a>
                </div>
            </div>
                        ...
                        @if ($detail->datetimes->count())
                            @foreach ($detail->datetimes as $key => $data)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.datetime.edit', [$detail->id, $data->id]) }}"
                                            class="btn btn-success btn-sm"><i class="fa fa-edit"></i>
                                        </a>
                                        <form class="mt-2"
                                            action="{{ route('admin.datetime.delete', [$detail->id, $data->id]) }}"
                                            method="post">
                                            @csrf
                                            @method('delete')
