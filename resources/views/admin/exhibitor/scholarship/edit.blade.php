            ...
            <div class="col-md-12">
                <div class="ibox">
                    ...
                    <div class="ibox-body" style="">
                        <form method="post" action="{{ route('admin.scholarship.update', [$exhibitorId, $detail->id]) }}"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="exhibitor_id" class="form-control">
                                        <option selected value="{{ $exhibitorId }}">{{ $detail->title }}</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="type" class="form-control" id="type">
                                        ...
                                        <option value="scholarship" {{ $detail->type == 'scholarship' ? 'selected' : '' }}>
                                            Scholarship</option>
                                        <option value="institution" {{ $detail->type == 'institution' ? 'selected' : '' }}>
                                            Institution</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6 download d-none">
                                    ...
                                    @if ($detail->download)
                                        <a target="_blank" class="btn btn-link"
                                            href="/document/{{ $detail->download }}">{{ $detail->download }}</a>
                                    @endif
                                </div>
