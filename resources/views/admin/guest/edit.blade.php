    ...
    <div class="col-md-12">
      <div class="ibox">
        ...
        <div class="ibox-body" style="">
          <form method="post" action="{{route('guest.update',$detail->id)}}" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
              <div class="col-md-8">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="designation" value="{{$detail->designation}}"
                    placeholder="Enter designation">
                </div>

                <div class="form-group">
                  <label>Organization</label>
                  <input type="text" class="form-control" name="organization" value="{{$detail->organization}}"
                ...
                <div class="check-list">
                  <label class="ui-checkbox ui-checkbox-primary">
                    <input name="publish" type="checkbox" {{ $detail->status == 1 ? 'checked': ''}}>
              ...
              <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div id="wrapper" class="mt-2">
                        <div id="image-holder">
                        @if($detail->photo)
                        <img src="{{asset('images/thumbnail/'. $detail->photo)}}"
