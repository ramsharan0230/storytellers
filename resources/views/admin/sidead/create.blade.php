    ...
    <div class="page-content fade-in-up">
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Create sidead </div>
                    ...
                    <div class="ibox-body" style="">
                        <form method="post" action="{{ route('sidead.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Link</label>
                                    <input name="link" value="{{ old('link') }}" type="text" class="form-control" required
                                        placeholder="link">
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Side ads</label>
                                    <input id="fileUpload1" class="form-control" value="" name="image" type="file">
