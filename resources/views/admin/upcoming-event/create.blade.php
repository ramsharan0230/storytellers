...
@section('page_title', 'Add Upcoming Event')
@push('styles')
...
<div class="page-content fade-in-up">
  <div class="row">
    <div class="col-md-12">
      <div class="ibox">
        <div class="ibox-head">
          <div class="ibox-title">Create Upcoming Event</div>
        ...
        <div class="ibox-body" style="">
            <form method="post" action="{{ route('upcomingevent.store') }}" enctype="multipart/form-data">
                <div class="row">
