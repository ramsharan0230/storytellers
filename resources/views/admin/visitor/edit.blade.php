...
@section('page_title', 'Edit academic')
...
<div class="page-content fade-in-up">
    ...
    @endif
    <form method="post" action="{{route('academic.update', $detail->id)}}" enctype="multipart/form-data">
        @csrf
        @method('put')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Edit academic qualification</div>
                    </div>
