...
@section('page_title', 'All passed years')
...
<div class="page-heading">
    <h1 class="page-title">Passed Year</h1>
    @include('admin.layouts._partials.messages.info')
</div>
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">All Passed Years</div>
            <div>
                <a class="btn btn-info btn-md" href="{{route('year.create')}}">Add year</a>
            </div>
        </div>
            ...
            <table id="example-table" class="table table-striped table-bordered table-hover" cellspacing="0"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('year.edit', $data->id)}}" class="btn btn-success btn-sm"><i
                                    class="fa fa-edit"></i>
                            </a>
                            <form action="{{route('year.destroy', $data->id)}}" method="post">
                                ...
                                <button class="btn btn-danger btn-sm" type="submit" name="button"
                                    ...
                                    onclick="return confirm('Are you sure you want to delete this year?')"><i
