            ...
            <div id="featured" class="tab-pane fade in active">
               <div class="row front-tab-wrapper">
                   ...
                   <div class="col-lg-4 col-md-6 col-6 col-wrapp">
                       <div class="featured-card">
                           <a href="#" class="feature-image">
                               <img src="images/home_ghana.jpg" alt="image"><span class="feature-time">29:30</span>
                            </a>
                            <a href="#" class="featured-title-wrapp">
                                ...
                                <div class="featured-title-side">
                                    <h3>The story of a conservationist with his tales of laughter and  ...</h3>
                                    <p class="featured-name">Dr. Ghana S. Gurung</p>
                                </div>
                            </a>
                       </div>
                   </div>
                   <div class="col-lg-4 col-md-6 col-6 col-wrapp">
                       <div class="featured-card">
                           <a href="#" class="feature-image">
                               <img src="images/home_manoj-kc.jpg" alt="image"><span class="feature-time">29:30</span>
                            </a>
                            <a href="#" class="featured-title-wrapp">
                                <span class="featured-icon"><img src="images/icon_arrrow-right_2-u4551-fr.png" id="hidden-on-hover" alt="icon"><img src="images/icon_arrrow-right_2-2.png" id="display-on-hover" alt="icon"></span>
                                <div class="featured-title-side">
                                    <h3>After many failures, I had a choice between teaching in schools ....</h3>
                                    <p class="featured-name">Mr. Manoj Kumar K.C., 1974 AD</p>
                                </div>
                            </a>
                       </div>
                   </div>
